...
class : public GeekShieldV2 {
  ...
  void setup() {
    ...
    setServoPulseRange(SERVO_2, 500, 2500);
    setServoPulseRange(SERVO_3, 500, 2500);
    setServoPulseRange(SERVO_4, 500, 2500);
  ...
  void processBluepadController(BluepadController* ctl) {
    ...
    updateServo(SERVO_2, normalizeStickInput(ctl->axisY()));
    updateServo(SERVO_3, normalizeStickInput(ctl->axisRX()));
    updateServo(SERVO_4, normalizeStickInput(ctl->axisRY()));
